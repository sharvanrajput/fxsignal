...
const Page = () => {
    ...
    return (
        <section className="about_banner pt-[150px] pb-[50px] bg-contain bg-center" style={{ backgroundImage: `url(${bg_shape_1.src})` }}>
            <div className="container">
                ...
                {/* Counter Section */}
                <div ref={ref} className="bg-yellow-100 py-8 px-4 rounded-[30px] w-full mx-auto mt-5">
