                        ...
                        <div className="grid lg:grid-cols-5 grid-cols-1 gap-10">
                            <div className='col-span-3'>
                                ...
                                <div className="disc ">
                                    ...
                                    <p className='mb-10'>You work hard for your money, but is your money working hard enough for you? With currency trading, you can tap into the massive global Forex market and potentially turn your savings into a wealth-building machine.</p>
                                    <h2 className='text-3xl mb-5 font-semibold'>What is Currency Trading?</h2>
                                    <p className='mb-10'>Currency Trading, also known as Forex or FX trading, is the buying and selling of global currencies. The Forex market is the largest and most liquid market in the world, with a staggering $6.6 trillion traded each day.</p>
                                    <p className='mb-10'>Just ponder that enormous figure for a little while. $6.6 trillion surpasses the GDP of the majority of nations! For lone traders like you, this sea of money that is constantly moving across the world offers a fantastic opportunity.</p>
                                    <h2 className='text-3xl mb-5 font-semibold'>How Currency Trading Works?</h2>
                                    <p className='mb-10'>The influence of Forex stretches far beyond international travel and investments. Here are some everyday examples:</p>
                                    <p className='mb-10'>At its core, currency trading involves speculating on whether the value of one currency will rise or fall compared to another currency. You are essentially betting that the currency you buy will increase in value versus the currency you sell.</p>
