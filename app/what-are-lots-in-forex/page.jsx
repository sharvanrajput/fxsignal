                        ...
                        <div className="grid lg:grid-cols-5 grid-cols-1 gap-10">
                            <div className='col-span-3'>
                                ...
                                <div className="disc ">
                                    ...
                                    <p className='mb-5'>Hey there, fellow trader! Ever heard of lots in Forex and felt like it's some secret code only the elites understand? Well, fear not, because I'm about to break it down for you in simple terms.</p>
                                    <p className='mb-5'>So, what the heck are lots anyway? In the wild world of Forex trading, a lot is basically the unit size you use to place your trades. Think of it like ordering pizza – you can either get a slice (a small lot) or the whole pie (a big lot).</p>
                                    <p className='mb-5'>Lots are the basic unit of measurement in Forex trading. They're like the building blocks you use to place your trades. The size of the lot you choose can have a big impact on your potential profits and losses, so it's important to get a handle on how they work.</p>
