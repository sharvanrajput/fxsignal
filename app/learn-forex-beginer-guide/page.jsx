                    ...
                    <div className="grid lg:grid-cols-5 grid-cols-1 gap-10">
                        <div className='col-span-3'>
                            ...
                            <div className="disc ">
                                ...
                                <p className='mb-5'>Forex, also known as foreign exchange, represents the global platform where currencies are traded. It stands as the largest and most fluid financial market globally, witnessing trillions of dollars changing hands daily. In Forex trading, individuals speculate on currency pair price movements with the aim of capitalizing on these fluctuations.</p>
                                <h2 className='text-3xl mb-5 font-semibold'>What Constitutes a Currency Pair?</h2>
                                <p className='mb-5'>Currencies are always traded in pairs while trading Forex. The initial currency in the pair is termed the base currency, while the subsequent one is the quote currency. For instance, in the EUR/USD pair, the euro acts as the base currency, and the US dollar serves as the quote currency.</p>
                                <h2 className='text-3xl mb-5 font-semibold'>How Does Forex Trading Operate?</h2>
                                <p className='mb-5'>Engaging in a currency pair purchase involves acquiring the base currency while selling the quote currency. Should one anticipate the base currency strengthening against the quote currency, purchasing the pair is advisable. Conversely, if the belief is in the base currency's weakening, selling the pair is preferable.</p>
                                <h2 className='text-3xl mb-5 font-semibold'>Factors Driving Forex Movements:</h2>
                                <p className='mb-5'>Numerous elements influence currency exchange rates, including interest rates, economic strength, political stability, and supply and demand dynamics. For instance, a flourishing US economy prompting interest rate hikes might attract foreign investors, thus elevating the value of the USD compared to EUR (EUR/USD).</p>
                            </div>
