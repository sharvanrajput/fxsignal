...
export default function Button({ href, children, withicon, variant = 'primary' }) {
    ...
    const variants = {
        primary: 'bg-light-yellow text-black px-5 py-2 flex items-center group overflow-hidden  rounded-sm ',
        outline: 'border border-light-yellow px-5 py-2 flex items-center group  overflow-hidden rounded-sm text-light-yellow ',
    };
