...
const page = () => {
    return (
        <>
            <section className="bg-banner-green px-0 py-30 md:pt-25 md:pb-0 ">
                <div className="max-w-9xl mx-auto grid grid-cols-1 xl:grid-cols-2 gap-8 ">

                    {/* Left Text Content */}
                    <div className="space-y-6 lg:ps-[110px] sm:ps-[70px] ps-[20] self-center">
                        <h1 className="  text-3xl  md:text-4xl font-bold text-white leading-tight">
                            Unlock Forex Signals <br className="sm:block hidden" /> to&nbsp;
                            <span className="relative md:h-[38px] h-[25px]   overflow-hidden   inline-block">
