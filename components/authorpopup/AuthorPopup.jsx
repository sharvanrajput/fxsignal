...
const AuthorPopup = ({ isOpen, onClose, onSubmit }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl lg:w-[600px] md:w-[400px] w-[320px] max-h-screen overflow-y-auto">
        <div className="flex justify-between items-start p-6">
          <div className="flex-1">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Become an Author at FXSignals</h2>
            <p className="text-gray-600 text-sm">Share your trading knowledge, inspire others with your general trading opportunities.</p>
          </div>
          <button
            onClick={onClose}
